...
export const BORDEREAU_PIECES: BordereauPiece[] = [
  ...
  },
  {
    ...
    date_versement: "23.07.2024",
    titre: {
      uk: "Докази заволодіння $15'000 USD · Аудіо/відеофіксація вимагання, чати та клопотання про витребування виписки Wise (ст. 192 КПК)",
      fr: "Faisceau probatoire du détournement de $15'000 USD · Aveu extrajudiciaire, échanges et réquisition bancaire Wise (Art. 192 CPP)",
      de: "Beweismittelbündel zur Veruntreuung von $15'000 USD · Geständnis, Korrespondenz & Editionsantrag Wise (Art. 192 StPO)",
      it: "Complesso probatorio dell'appropriazione di $15'000 USD · Confessione, chat e istanza di produzione bancaria Wise (Art. 192 CPP)",
      en: "Evidence Chain of $15,000 USD Misappropriation · Extrajudicial Admission, Chat Evidence & Subpoena Motion (Art. 192 CPC)",
    },
    categorie: "Bancaire",
    sha256: "9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08",
    admissibilite: {
      uk: "Сукупність непрямих доказів (ст. 139 КПК) та судове витребування (ст. 192 КПК)",
      fr: "Faisceau d'indices convergents (Art. 139 CPP) et réquisition de production (Art. 192 CPP)",
      de: "Beweismittelbündel (Art. 139 StPO) und Editionsverfügung (Art. 192 StPO)",
      it: "Complesso di indizi concordanti (Art. 139 CPP) e istanza di produzione (Art. 192 CPP)",
      en: "Convergent circumstantial evidence (Art. 139 CPC) and judicial subpoena (Art. 192 CPC)",
    },
    portee_probatoire: {
      uk: "Сукупність непрямих доказів: аудіозапис визнання Любові Суворової («ти нічого не доведеш»), листування з вимогою коштів, свідчення потерпілого Арсена Коваленка та офіційне клопотання до прокурора про витребування транзакцій Wise за ст. 192 КПК.",
      fr: "Faisceau d'indices convergents (Art. 139 CPP) : aveu péremptoire de Liubov Suvorova (« tu ne prouveras rien »), messages de chantage, témoignage de la victime et réquisition de production judiciaire ordonnée à Wise par le Ministère public (Art. 192 CPP).",
      de: "Schlüssiges Beweisbündel: Geständnis der Beschuldigten («du beweist nichts»), Erpressungsnachrichten, Zeugenaussage des Opfers und Editionsantrag an die Staatsanwaltschaft gemäss Art. 192 StPO.",
      it: "Complesso di indizi concordanti: confessione dell'imputata («non proverai nulla»), messaggi di ricatto, testimonianza della vittima e richiesta di ordine di esibizione bancaria ex Art. 192 CPP.",
      en: "Convergent chain of evidence: extrajudicial admission by Liubov Suvorova ('you will prove nothing'), extortion chats, victim testimony, and formal motion for judicial subpoena to Wise under Art. 192 CPC.",
    },
    citation_cle: {
      uk: "« ...Гроші витрачені, ти нічого не отримаєш і нічого не доведеш... » (Аудіо 35) · Клопотання про витребування виписки Wise за ст. 192 КПК Во.",
      fr: "« ...L'argent est dépensé, tu n'auras rien et tu ne prouveras rien... » (Audio 35) · Réquisition de production de documents bancaires selon l'art. 192 CPP.",
      de: "« ...Das Geld ist ausgegeben, du kriegst nichts und beweist nichts... » (Audio 35) · Editionsantrag für Bankunterlagen gemäss Art. 192 StPO.",
      it: "« ...I soldi sono spesi, non avrai nulla e non proverai nulla... » (Audio 35) · Istanza di produzione di documenti bancari ex art. 192 CPP.",
      en: "« ...The money is spent, you will get nothing and prove nothing... » (Audio 35) · Motion for production of bank documents under Art. 192 CPC.",
    },
    fichier_local: "/evidence/photos/P-05_bancaire_wise.jpg",
    adr_id: "ADR-005",
    adr_title: {
      uk: "Заволодіння $15k USD & Витребування Wise (ст. 192 КПК)",
      fr: "Détournement $15k USD & Réquisition Wise (Art. 192 CPP)",
      de: "Unterschlagung $15k USD & Editionsantrag Wise",
      it: "Appropriazione $15k USD & Istanza Wise",
      en: "Misappropriation $15k USD & Subpoena Wise",
    },
    adr_sync: true,
    exif_meta: {
      camera: "Système de réquisition judiciaire Ministère public VD",
      lens: "Enregistrement probatoire ISO/IEC 27037",
      timestamp: "02.04.2024 10:15:22 UTC",
      gps: "46.5197° N, 6.6323° E (Lausanne)",
      iso: 100,
      aperture: "Art. 192 & 263 CPP",
      alibi_verification: {
        uk: "Ланцюг доказів (аудіо 35 + чати) обґрунтовує винесення слідчим прокурором ордера на витребування виписки Wise та арешт рахунків (ст. 192, 263 КПК).",
        fr: "Le faisceau d'indices (audio 35 + messagerie) fonde l'ordonnance de production bancaire Wise et le séquestre conservatoire par le Procureur (Art. 192, 263 CPP).",
        de: "Das Beweismittelbündel (Audio 35 + Chat) begründet den Editionsbefehl für Wise und die Beschlagnahme durch den Staatsanwalt (Art. 192, 263 StPO).",
        it: "Il complesso indiziario (audio 35 + messaggi) fonda l'ordine di esibizione bancaria Wise e il sequestro conservativo (Art. 192, 263 CPP).",
        en: "The chain of evidence (Audio 35 + chats) grounds the judicial subpoena to Wise and conservatory sequestration order by the Prosecutor (Art. 192, 263 CPC).",
      },
    },
  },
  {
