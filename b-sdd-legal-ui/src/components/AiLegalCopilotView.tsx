...
export const AiLegalCopilotView: React.FC<AiLegalCopilotViewProps> = ({
  ...
  const [messages, setMessages] = useState<CopilotMessage[]>([
    {
      ...
      text:
        currentLang === "uk"
          ? `Вітаю в юридичному ШІ-копілоті Astryx. Я підключений до темпоральної бази Utopia DB (порт 9922) та корпусу швейцарських законів MemPalace (порт 8766) для справи ${activeCase.reference}.\n\nЯ можу:\n1. Знайти статті кодексів Швейцарії (CP, CPP, CC, CO, LEI) та прецеденти ATF.\n2. Здійснити аудит суперечностей між заявами обвинувачених та доказами P-01..P-15.\n3. Розрахувати радіус ураження (Blast Radius) для будь-якої зміни факту.\n4. Скласти клопотання про арешт банківських рахунків (ст. 263 КПК) чи слідчі дії (ст. 318 КПК).\n\nВсі висновки автоматично формуються та узгоджуються на 5 мовах (Українська, Français, Deutsch, Italiano, English).`
          : currentLang === "it"
          ? `Benvenuto nel Copilot Giuridico IA Astryx. Connesso al database bitemporale Utopia DB (:9922) e al corpus giuridico svizzero MemPalace (:8766) per il fascicolo ${activeCase.reference}.\n\nFunzionalità operative:\n1. Ricerca incrociata nel diritto federale svizzero (CP, CPP, CC, CO, LStrl) e sentenze del Tribunale Federale (DTF).\n2. Audit delle contraddizioni oggettive (P-01..P-15, referto medico Unisanté, EXIF 1481).\n3. Calcolo del raggio d'impatto (Blast Radius) sui 18 capitoli del dossier.\n4. Redazione delle istanze di sequestro conservativo (Art. 263 CPP) e istanze probatorie (Art. 318 CPP).\n\nLe conclusioni sono sincronizzate in 5 lingue (Italiano, Français, Deutsch, Українська, English).`
          : currentLang === "de"
          ? `Willkommen beim juristischen KI-Copilot Astryx. Verbunden mit der bitemporalen Datenbank Utopia DB (:9922) und dem Schweizer Rechtskorpus MemPalace (:8766) für das Dossier ${activeCase.reference}.\n\nAktive Funktionen:\n1. Recherche im Bundesrecht (StGB, StPO, ZGB, OR, AIG) und in Leitentscheiden des Bundesgerichts (BGE).\n2. Widerspruchsaudit zwischen Beschuldigtenaussagen und Beweisen P-01..P-15.\n3. Berechnung des Schadensradius (Blast Radius) bei Sachverhaltsänderungen.\n4. Abfassen von Beschlagnahmeanträgen (Art. 263 StPO) und Beweisanträgen (Art. 318 StPO).\n\nAlle rechtlichen Schlussfolgerungen werden synchron in 5 Sprachen ausgegeben.`
          : currentLang === "fr"
          ? `Bienvenue dans l'Assistant IA Astryx. Connecté à la base bitemporelle Utopia DB (:9922) et au corpus de droit suisse MemPalace (:8766) pour le dossier ${activeCase.reference}.\n\nCapacités actives :\n1. Recherche croisée dans le corpus fédéral (CP, CPP, CC, CO, LEI) et ATF.\n2. Audit des contradictions objectives (P-01 à P-15, certificat médical Unisanté, EXIF 1481).\n3. Calculateur de rayon d'impact (Blast Radius) sur les 18 chapitres.\n4. Rédaction de réquisitions selon l'Art. 263 CPP (séquestre) et Art. 318 CPP.\n\nConclusions synchronisées en 5 langues.`
          : `Welcome to the Astryx Legal AI Copilot. Connected to the bitemporal Utopia DB (:9922) and the Swiss Law corpus MemPalace (:8766) for proceeding ${activeCase.reference}.\n\nCapabilities:\n1. Federal Swiss Law & ATF cross-referencing.\n2. Objective contradiction audit across exhibits P-01 to P-15.\n3. Blast radius analysis across 18 chapters.\n4. Drafting motions under Art. 263 CPC and Art. 318 CPC.\n\nAll conclusions are delivered across all 5 supported languages.`,
      timestamp: "12:00",
      citations: [
        { title: "Escroquerie / Truffa / Betrug", ref: "Art. 146 CP" },
        { title: "Séquestre pénal / Sequestro", ref: "Art. 263 CPP" },
  ...
  const handleSendQuery = (textToSend?: string) => {
    ...
    setTimeout(() => {
      ...
      if (lower.includes("146") || lower.includes("escroquerie") || lower.includes("шахрайство") || lower.includes("truffa") || lower.includes("betrug") || lower.includes("15'000") || lower.includes("wise")) {
        if (currentLang === "uk") {
          responseText = `⚖️ **Аналіз кваліфікації за ст. 146 КК Швейцарії (Escroquerie / Шахрайство)**:\n\n1. **Підступність обману (Tromperie astucieuse)**: Обвинувачена побудувала складну конструкцію фіктивного «довірчого збереження коштів для статусу S». Згідно з практикою Федерального суду (ATF 141 IV 369), вразливість потерпілого захищається законом.\n2. **Матеріальна доказова база**: Виписка Wise на $15'000 USD (Pièce P-05, SHA-256: b10a9f5d...) у поєднанні із зізнанням на аудіозаписі P-04 повністю виключає версію захисту про «безповоротний подарунок».\n3. **Вимога цивільного позову (ст. 122 КПК)**: $15'000 USD (еквівалент CHF 13'500.00) підлягають безумовній реституції плюс відсотки 5% річних за ст. 104 CO.\n\n🌐 **Висновки ШІ-агента всіма мовами (5 мов)**:\n• 🇺🇦 UA: Склад шахрайства (ст. 146 КК) та привласнення (ст. 138 КК) доведено повністю.\n• 🇮🇹 IT: Reato di truffa (Art. 146 CP) e appropriazione indebita (Art. 138 CP) pienamente configurato.\n• 🇩🇪 DE: Tatbestand des Betrugs (Art. 146 StGB) und der Veruntreuung (Art. 138 StGB) erfüllt.\n• 🇫🇷 FR: Infraction d'escroquerie (Art. 146 CP) et abus de confiance (Art. 138 CP) consommée.\n• 🇬🇧 EN: Offense of fraud (Art. 146 SCC) and embezzlement (Art. 138 SCC) established.`;
        } else if (currentLang === "it") {
          responseText = `⚖️ **Analisi di qualificazione giuridica ex Art. 146 CP Svizzero (Truffa / Escroquerie)**:\n\n1. **Inganno astuto (Astuzia / DTF 141 IV 369)**: L'imputata ha orchestrato una falsa messa in scena relativa a un presunto «deposito fiduciario vincolato allo Statuto S». La vulnerabilità linguistica della persona lesa non esclude affatto l'astuzia penale.\n2. **Corroborazione probatoria materiale**: La contabile di bonifico Wise di $15'000 USD (Prova P-05, hash SHA-256 certificato) e l'ammissione esplicita nell'audio P-04 annientano la tesi della difesa su una pretesa donazione.\n3. **Azione civile d'adesione (Art. 122 CPP)**: Restituzione integrale di $15'000 USD (CHF 13'500.00) oltre a interessi moratori al 5% annuo (Art. 104 CO).\n\n🌐 **Conclusioni dell'Agente IA in tutte le lingue (5 lingue)**:\n• 🇮🇹 IT: Reato di truffa (Art. 146 CP) e appropriazione indebita (Art. 138 CP) pienamente configurato.\n• 🇺🇦 UA: Склад шахрайства (ст. 146 КК) та привласнення (ст. 138 КК) доведено повністю.\n• 🇩🇪 DE: Tatbestand des Betrugs (Art. 146 StGB) und der Veruntreuung (Art. 138 StGB) erfüllt.\n• 🇫🇷 FR: Infraction d'escroquerie (Art. 146 CP) et abus de confiance (Art. 138 CP) consommée.\n• 🇬🇧 EN: Offense of fraud (Art. 146 SCC) and embezzlement (Art. 138 SCC) established.`;
        } else if (currentLang === "de") {
          responseText = `⚖️ **Rechtliche Würdigung unter Art. 146 StGB (Betrug)**:\n\n1. **Arglistige Täuschung (BGE 141 IV 369)**: Die Beschuldigte baute eine erfundene Inszenierung bezüglich einer «treuhänderischen Hinterlegung für den Schutzstatus S» auf. Die sprachliche Schutzbedürftigkeit des Geschädigten schliesst die Arglist keineswegs aus.\n2. **Sachliche Beweislage**: Der Wise-Überweisungsbeleg über $15'000 USD (Beweisstück P-05, SHA-256 zertifiziert) und das Geständnis auf Audio P-04 widerlegen die Behauptung einer Schenkung vollkommen.\n3. **Zivilrechtliche Rechtsbegehren (Art. 122 StPO)**: Vollständige Rückerstattung der $15'000 USD (CHF 13'500.00) zuzüglich Verzugszinsen von 5% (Art. 104 OR).\n\n🌐 **Schlussfolgerungen des KI-Agenten in allen Sprachen (5 Sprachen)**:\n• 🇩🇪 DE: Tatbestand des Betrugs (Art. 146 StGB) und der Veruntreuung (Art. 138 StGB) erfüllt.\n• 🇮🇹 IT: Reato di truffa (Art. 146 CP) e appropriazione indebita (Art. 138 CP) pienamente configurato.\n• 🇺🇦 UA: Склад шахрайства (ст. 146 КК) та привласнення (ст. 138 КК) доведено повністю.\n• 🇫🇷 FR: Infraction d'escroquerie (Art. 146 CP) et abus de confiance (Art. 138 CP) consommée.\n• 🇬🇧 EN: Offense of fraud (Art. 146 SCC) and embezzlement (Art. 138 SCC) established.`;
        } else if (currentLang === "fr") {
          responseText = `⚖️ **Qualification sous l'Art. 146 CP (Escroquerie)** :\n\n1. **Astuce (ATF 141 IV 369)** : La prévenue a échafaudé une mise en scène trompeuse relative à un « dépôt fiduciaire pour le Statut S ». La vulnérabilité linguistique du plaignant ne prive pas la tromperie de son caractère astucieux.\n2. **Corroboration matérielle** : Le bordereau de virement Wise de $15'000 USD (Pièce P-05, SHA-256 certifié) et l'aveu audio P-04 ruinent la thèse adverse d'une prétendue donation.\n3. **Prétentions civiles (Art. 122 CPP)** : Restitution intégrale des $15'000 USD augmentés des intérêts moratoires de 5% l'an (Art. 104 CO).\n\n🌐 **Conclusions de l'Agent IA en toutes langues (5 langues)** :\n• 🇫🇷 FR: Infraction d'escroquerie (Art. 146 CP) consommée.\n• 🇮🇹 IT: Reato di truffa (Art. 146 CP) pienamente configurato.\n• 🇩🇪 DE: Tatbestand des Betrugs (Art. 146 StGB) erfüllt.\n• 🇺🇦 UA: Склад шахрайства (ст. 146 КК) доведено.\n• 🇬🇧 EN: Offense of fraud (Art. 146 SCC) established.`;
        } else {
          responseText = `⚖️ **Legal Analysis under Art. 146 Swiss Criminal Code (Fraud)**:\n\n1. **Deceit and Malice (ATF 141 IV 369)**: The defendant orchestrated a fraudulent scenario claiming a mandatory escrow for Status S protection.\n2. **Corroborating Evidence**: Wise wire slip for $15,000 USD (Exhibit P-05, SHA-256 verified) and confession on recording P-04 conclusively refute gift claims.\n3. **Civil Plaintiff Claims (Art. 122 CPC)**: Full restitution of $15,000 USD plus 5% statutory interest (Art. 104 CO).\n\n🌐 **AI Agent Multilingual Conclusions (5 languages)**:\n• 🇬🇧 EN: Fraud (Art. 146 SCC) and embezzlement (Art. 138 SCC) corroborated.\n• 🇮🇹 IT: Truffa (Art. 146 CP) e appropriazione indebita (Art. 138 CP) accertati.\n• 🇩🇪 DE: Betrug (Art. 146 StGB) und Veruntreuung (Art. 138 StGB) erwiesen.\n• 🇫🇷 FR: Escroquerie (Art. 146 CP) et abus de confiance (Art. 138 CP) établis.\n• 🇺🇦 UA: Шахрайство (ст. 146 КК) та привласнення (ст. 138 КК) доведено.`;
        }
        citations = [
          { title: "Escroquerie / Truffa / Betrug", ref: "Art. 146 CP" },
      ...
      } else if (lower.includes("146 iv 9") || lower.includes("admissib") || lower.includes("допустим") || lower.includes("p-01") || lower.includes("аудіо") || lower.includes("registrazion") || lower.includes("aufnahme")) {
        if (currentLang === "uk") {
          responseText = `🛡️ **Оцінка допустимості аудіозаписів за практикою Федерального суду ATF 146 IV 9**:\n\n- **Нормативна база**: ст. 139 ч. 1 та ст. 141 ч. 2 КПК Швейцарії.\n- **Баланс інтересів**: Федеральний суд встановив, що таємні аудіозаписи, зроблені потерпілим для захисту від тяжких злочинів (погрози вбивством ст. 180 КК, примус ст. 181 КК, вимагання), є **повністю допустимими доказами**, оскільки інтерес до встановлення істини значно переважає право обвинуваченої на конфіденційність слів.\n- **Статус P-01**: Аудіозапис 32 містить прямі погрози розправою («Я тебе знищу, поліція нічого не зробить»). Запис верифіковано криміналістичним хешем SHA-256 ISO/IEC 27037.\n\n🌐 **Висновки ШІ-агента всіма мовами (5 мов)**:\n• 🇺🇦 UA: Аудіо P-01 є допустимим доказом згідно з ATF 146 IV 9.\n• 🇮🇹 IT: Registrazione P-01 pienamente ammissibile ex DTF 146 IV 9.\n• 🇩🇪 DE: Tonaufnahme P-01 nach BGE 146 IV 9 vollumfänglich verwertbar.\n• 🇫🇷 FR: Audio P-01 exploitable selon la jurisprudence ATF 146 IV 9.\n• 🇬🇧 EN: Audio P-01 admissible under ATF 146 IV 9 precedent.`;
        } else if (currentLang === "it") {
          responseText = `🛡️ **Ammissibilità delle registrazioni audio secondo la giurisprudenza federale di principio DTF 146 IV 9**:\n\n- **Quadro normativo**: Art. 139 cpv. 1 e Art. 141 cpv. 2 CPP svizzero.\n- **Ponderazione degli interessi**: Il Tribunale federale stabilisce che le registrazioni effettuate all'insu dell'autore per difendersi da reati gravi contro la persona e il patrimonio (Art. 180, 181, 146 CP) sono **pienamente ammissibili come prova**, prevalendo l'interesse pubblico all'accertamento della verità.\n- **Valore probatorio di P-01**: La prova P-01 documenta le minacce di morte gravi («Ti distruggerò, la polizia non farà nulla») ed è sigillata con hash SHA-256 ISO/IEC 27037.\n\n🌐 **Conclusioni dell'Agente IA in tutte le lingue (5 lingue)**:\n• 🇮🇹 IT: Registrazione P-01 pienamente ammissibile ex DTF 146 IV 9.\n• 🇺🇦 UA: Аудіо P-01 є допустимим доказом згідно з ATF 146 IV 9.\n• 🇩🇪 DE: Tonaufnahme P-01 nach BGE 146 IV 9 vollumfänglich verwertbar.\n• 🇫🇷 FR: Audio P-01 exploitable selon la jurisprudence ATF 146 IV 9.\n• 🇬🇧 EN: Audio P-01 admissible under ATF 146 IV 9 precedent.`;
        } else if (currentLang === "de") {
          responseText = `🛡️ **Verwertbarkeit von Tonaufnahmen nach der Leitpraxis BGE 146 IV 9**:\n\n- **Normative Grundlagen**: Art. 139 Abs. 1 und Art. 141 Abs. 2 StPO.\n- **Güterabwägung**: Das Bundesgericht anerkennt die Verwertbarkeit heimlicher Tonaufnahmen zum Schutz vor schweren Delikten (Art. 180, 181, 146 StGB). Das öffentliche Interesse an der Wahrheitsfindung überwiegt den Persönlichkeitsschutz der Beschuldigten.\n- **Beweiskraft P-01**: Dokumentiert schwere Drohungen («Ich mach dich fertig») mit kryptographischer SHA-256-Sicherung.\n\n🌐 **Schlussfolgerungen des KI-Agenten in allen Sprachen (5 Sprachen)**:\n• 🇩🇪 DE: Tonaufnahme P-01 nach BGE 146 IV 9 vollumfänglich verwertbar.\n• 🇮🇹 IT: Registrazione P-01 pienamente ammissibile ex DTF 146 IV 9.\n• 🇺🇦 UA: Аудіо P-01 є допустимим доказом згідно з ATF 146 IV 9.\n• 🇫🇷 FR: Audio P-01 exploitable selon la jurisprudence ATF 146 IV 9.\n• 🇬🇧 EN: Audio P-01 admissible under ATF 146 IV 9 precedent.`;
        } else if (currentLang === "fr") {
          responseText = `🛡️ **Admissibilité de l'audio P-01 selon la jurisprudence de principe ATF 146 IV 9** :\n\n- **Cadre légal** : Art. 139 al. 1 et Art. 141 al. 2 CPP.\n- **Pesée des intérêts** : Le Tribunal fédéral admet l'exploitabilité d'enregistrements réalisés à l'insu de l'auteur dès lors qu'il s'agit de prouver des infractions graves contre l'intégrité (Art. 180, 181, 146 CP). L'intérêt public à la manifestation de la vérité prime.\n- **Force probatoire** : La pièce P-01 documente formellement les menaces de mort réitérées (« Je vais t'abattre ») et porte un scellement SHA-256 conforme ISO/IEC 27037.\n\n🌐 **Conclusions de l'Agent IA en toutes langues (5 langues)** :\n• 🇫🇷 FR: Audio P-01 exploitable selon ATF 146 IV 9.\n• 🇮🇹 IT: Registrazione P-01 pienamente ammissibile ex DTF 146 IV 9.\n• 🇩🇪 DE: Tonaufnahme P-01 nach BGE 146 IV 9 verwertbar.\n• 🇺🇦 UA: Аудіо P-01 допустиме за ATF 146 IV 9.\n• 🇬🇧 EN: Audio P-01 admissible under ATF 146 IV 9.`;
        } else {
          responseText = `🛡️ **Admissibility of Audio P-01 under Leading Precedent ATF 146 IV 9**:\n\n- **Legal Standard**: Art. 139 para 1 and Art. 141 para 2 Swiss CPC.\n- **Balancing of Interests**: The Supreme Court admits unconsented recordings where severe crimes against personal integrity or property are established.\n- **Tangible Exhibit P-01**: Documents explicit death threats verified by SHA-256.\n\n🌐 **AI Agent Multilingual Conclusions (5 languages)**:\n• 🇬🇧 EN: Exhibit P-01 is admissible under ATF 146 IV 9.\n• 🇮🇹 IT: Prova P-01 pienamente ammissibile ex DTF 146 IV 9.\n• 🇩🇪 DE: Beweisstück P-01 nach BGE 146 IV 9 verwertbar.\n• 🇫🇷 FR: Pièce P-01 exploitable selon ATF 146 IV 9.\n• 🇺🇦 UA: Доказ P-01 допустимий за ATF 146 IV 9.`;
        }
        citations = [
          { title: "Admissibilité / Ammissibilità DTF", ref: "ATF 146 IV 9" },
          { title: "Administration des preuves", ref: "Art. 139 CPP" },
          { title: "Menaces caractérisées", ref: "Art. 180 CP" },
        ];
      } else if (lower.includes("alibi") || lower.includes("алібі") || lower.includes("1481") || lower.includes("lausanne") || lower.includes("лозанн") || lower.includes("losanna") || lower.includes("303")) {
        if (currentLang === "uk") {
          responseText = `📍 **Спростування сфабрикованого нападу: Лозаннське алібі (EXIF 1481)**:\n\n1. **Часово-просторовий аналіз ($T_v$)**: Обвинувачена подала заяву до поліції про нібито нанесення тілесних ушкоджень у квартирі в Рене 20.07.2024.\n2. **Об'єктивний доказ P-06**: Знімок iPhone 14 Pro на площі Палю у Лозанні (GPS 46.5197° N, 6.6323° E) зафіксований о 13:45:12, із спектральним підтвердженням абсолютно чистих передпліч без подряпин.\n3. **Медичний висновок Unisanté (P-03)**: Огляд лікаря підтверджує відсутність слідів боротьби.\n4. **Зізнання на записі P-07**: Сама Суворова визнає, що роздряпала себе власними нігтями для фальсифікації доказу.\n\n➔ **Висновок**: Встановлено повний склад злочину **завідомо неправдивого доносу за ст. 303 ч. 1 КК** (Dénonciation calomnieuse).\n\n🌐 **Висновки ШІ-агента всіма мовами (5 мов)**:\n• 🇺🇦 UA: Склад завідомо неправдивого доносу (ст. 303 КК) підтверджено беззаперечним алібі.\n• 🇮🇹 IT: Reato di calunnia e falsa accusa (Art. 303 CP) comprovato da alibi oggettivo.\n• 🇩🇪 DE: Tatbestand der falschen Anschuldigung (Art. 303 StGB) durch Alibi bewiesen.\n• 🇫🇷 FR: Dénonciation calomnieuse (Art. 303 CP) établie par l'alibi objectif.\n• 🇬🇧 EN: Malicious false accusation (Art. 303 SCC) proven by objective alibi.`;
        } else if (currentLang === "it") {
          responseText = `📍 **Confutazione dell'aggressione fabbricata: Alibi oggettivo di Losanna (EXIF 1481)**:\n\n1. **Analisi spazio-temporale ($T_v$)**: L'imputata ha denunciato alla polizia una presunta aggressione fisica nell'appartamento di Renens.\n2. **Prova materiale irrefutabile P-06**: Metadati EXIF registrati alle 13:45:12 a Losanna (Place de la Palud) che documentano gli avambracci completamente integri e privi di lesioni.\n3. **Referto medico Unisanté (P-03)**: Assoluta assenza di lesioni corporee o colluttazione.\n4. **Confessione nell'audio P-07**: L'imputata ammette di essersi graffiata da sola per fabbricare una prova falsa.\n\n➔ **Conclusione**: Il reato di **calunnia / falsa accusa ex Art. 303 cpv. 1 CP** è pienamente consumato.\n\n🌐 **Conclusioni dell'Agente IA in tutte le lingue (5 lingue)**:\n• 🇮🇹 IT: Reato di calunnia e falsa accusa (Art. 303 CP) comprovato da alibi oggettivo.\n• 🇺🇦 UA: Склад завідомо неправдивого доносу (ст. 303 КК) підтверджено беззаперечним алібі.\n• 🇩🇪 DE: Tatbestand der falschen Anschuldigung (Art. 303 StGB) durch Alibi bewiesen.\n• 🇫🇷 FR: Dénonciation calomnieuse (Art. 303 CP) établie par l'alibi objectif.\n• 🇬🇧 EN: Malicious false accusation (Art. 303 SCC) proven by objective alibi.`;
        } else if (currentLang === "de") {
          responseText = `📍 **Widerlegung des fabrizierten Angriffs: Lausanner Alibi (EXIF 1481)**:\n\n1. **Raum-zeitliche Analyse ($T_v$)**: Die Beschuldigte erstattete Anzeige wegen eines angeblichen Angriffs in Renens.\n2. **Unwiderlegbares Beweismittel P-06**: EXIF-Metadaten um 13:45:12 Uhr in Lausanne (Place de la Palud) belegen vollkommen unverletzte Unterarme.\n3. **Arztzeugnis Unisanté (P-03)**: Totale Abwesenheit jeglicher Verletzungsspuren.\n4. **Geständnis auf Audio P-07**: Die Beschuldigte räumt ein, sich die Kratzspuren selbst beigebracht zu haben.\n\n➔ **Rechtsfolge**: Der Tatbestand der **falschen Anschuldigung gemäss Art. 303 Abs. 1 StGB** ist vollendet.\n\n🌐 **Schlussfolgerungen des KI-Agenten in allen Sprachen (5 Sprachen)**:\n• 🇩🇪 DE: Falsche Anschuldigung (Art. 303 StGB) durch Alibi lückenlos erwiesen.\n• 🇮🇹 IT: Calunnia (Art. 303 CP) accertata mediante alibi inconfutabile.\n• 🇺🇦 UA: Склад ст. 303 КК повністю доведено алібі P-06.\n• 🇫🇷 FR: Dénonciation calomnieuse (Art. 303 CP) démontrée.\n• 🇬🇧 EN: False accusation (Art. 303 SCC) substantiated by EXIF alibi.`;
        } else {
          responseText = `📍 **Demolition of Fabricated Assault Claim: Objective Lausanne Alibi (EXIF 1481)**:\n\n1. **Spatio-Temporal Calibration**: Defendant alleged domestic battery in Renens.\n2. **Objective Evidence P-06**: EXIF metadata at 13:45:12 in Lausanne demonstrates unblemished forearms.\n3. **Unisanté Certificate P-03**: Total absence of physical lesions.\n4. **Audio P-07 Confession**: Defendant admits self-inflicted scratching.\n\n➔ **Legal Consequence**: Offense of **malicious false accusation under Art. 303 SCC** is fully consummated.\n\n🌐 **AI Agent Multilingual Conclusions (5 languages)**:\n• 🇬🇧 EN: False accusation (Art. 303 SCC) corroborated by EXIF alibi.\n• 🇮🇹 IT: Calunnia (Art. 303 CP) accertata mediante alibi inconfutabile.\n• 🇩🇪 DE: Falsche Anschuldigung (Art. 303 StGB) lückenlos erwiesen.\n• 🇫🇷 FR: Dénonciation calomnieuse (Art. 303 CP) démontrée.\n• 🇺🇦 UA: Склад ст. 303 КК доведено алібі P-06.`;
        }
        citations = [
          { title: "Dénonciation calomnieuse / Calunnia", ref: "Art. 303 CP" },
      ...
      } else if (lower.includes("milli") || lower.includes("міллі") || lower.includes("933") || lower.includes("bonne foi") || lower.includes("buona fede") || lower.includes("gutgläubig") || lower.includes("добросовісн") || lower.includes("італій") || lower.includes("italian")) {
        if (currentLang === "uk") {
          responseText = `🛡️ **ІНВАРІАНТ L-03: Санктуаризований щит добросовісності Адріано Міллі (ст. 933 ЦК)**:\n\n1. **Походження та обставини**: Адріано Міллі є італійцем за походженням та нинішнім чоловіком/співмешканцем колишньої дружини. Він надавав суто законну гуманітарну допомогу та переклад у повній добросовісності.\n2. **Матеріальний захист за ст. 933 ЦК Швейцарії (CC)**: Особа, яка діє добросовісно, користується неспростовною презумпцією та захищена від будь-яких кримінальних чи цивільних претензій.\n3. **Процесуальний статус (ст. 105 ч. 2 КПК)**: Будь-які спроби сторони захисту втягнути його в якості обвинуваченого відхиляються d'office як зловживання правом (ст. 2 ч. 2 CC).\n4. **Архітектурна фіксація**: У реєстрі справи діє блокування будь-якої зміни його статусу.\n\n🌐 **Висновки ШІ-агента всіма мовами (5 мов)**:\n• 🇺🇦 UA: Адріано Міллі має абсолютний імунітет добросовісної третьої сторони (ст. 933 ЦК, Інваріант L-03).\n• 🇮🇹 IT: Adriano Milli (di origine italiana) gode di immunità assoluta quale terzo di buona fede (Art. 933 CC, Invariante L-03).\n• 🇩🇪 DE: Adriano Milli (italienischer Herkunft) besitzt absolute Verfahrensimmunität als gutgläubiger Dritter (Art. 933 ZGB, L-03).\n• 🇫🇷 FR: Adriano Milli bénéficie d'une immunité totale et inviolable de tiers de bonne foi (Art. 933 CC, Invariant L-03).\n• 🇬🇧 EN: Adriano Milli possesses absolute immunity as a protected bona fide third party (Art. 933 CC, Invariant L-03).`;
        } else if (currentLang === "it") {
          responseText = `🛡️ **INVARIANTE L-03: Scudo inviolabile del terzo di buona fede per Adriano MILLI (Art. 933 CC)**:\n\n1. **Origine e circostanze del fatto**: Adriano Milli è di origine italiana ed è l'attuale marito/convivente dell'ex moglie. Ha prestato unicamente assistenza umanitaria e traduzione linguistica in totale buona fede.\n2. **Protezione sostanziale ex Art. 933 Codice Civile svizzero**: Il terzo in buona fede beneficia di una presunzione legale insuperabile ed è totalmente al riparo da qualsiasi azione di rivalsa o pretesa patrimoniale.\n3. **Status processuale (Art. 105 cpv. 2 CPP)**: La sua presenza è circoscritta ad atti di mera assistenza disinteressata. Qualsiasi querela o istanza temeraria della difesa diretta contro di lui è colpita da irricevibilità d'ufficio per divieto dell'abuso di diritto (Art. 2 cpv. 2 CC).\n4. **Blocco architetturale**: L'Invariante L-03 vieta formalmente e crittograficamente qualsiasi modifica del suo status o apertura di procedimenti nei suoi confronti.\n\n🌐 **Conclusioni dell'Agente IA in tutte le lingue (5 lingue)**:\n• 🇮🇹 IT: Adriano Milli (di origine italiana) gode di immunità assoluta quale terzo di buona fede (Art. 933 CC, Invariante L-03).\n• 🇺🇦 UA: Адріано Міллі має абсолютний імунітет добросовісної третьої сторони (ст. 933 ЦК, Інваріант L-03).\n• 🇩🇪 DE: Adriano Milli (italienischer Herkunft) besitzt absolute Verfahrensimmunität als gutgläubiger Dritter (Art. 933 ZGB, L-03).\n• 🇫🇷 FR: Adriano Milli bénéficie d'une immunité totale et inviolable de tiers de bonne foi (Art. 933 CC, Invariant L-03).\n• 🇬🇧 EN: Adriano Milli possesses absolute immunity as a protected bona fide third party (Art. 933 CC, Invariant L-03).`;
        } else if (currentLang === "de") {
          responseText = `🛡️ **INVARIANTE L-03: Absoluter Schutzschild für den gutgläubigen Dritten Adriano MILLI (Art. 933 ZGB)**:\n\n1. **Herkunft und Sachverhalt**: Adriano Milli ist italienischer Herkunft und der derzeitige Lebenspartner/Ehemann der Ex-Frau. Er leistete ausschliesslich gutgläubige humanitäre Hilfe und Übersetzungsdienste.\n2. **Materieller Schutz nach Art. 933 Schweizerisches ZGB**: Der gutgläubige Dritte geniesst eine unwiderlegbare Gutglaubensvermutung und vollen Schutz vor Regress- oder Zivilforderungen.\n3. **Verfahrensstatus (Art. 105 Abs. 2 StPO)**: Seine Mitwirkung war rein uneigennützig. Jeder Versuch der Verteidigung, ihn als Mittäter anzuklagen, wird von Amtes wegen als Rechtsmissbrauch (Art. 2 Abs. 2 ZGB) abgewiesen.\n4. **Kryptographische Verankerung**: Invariante L-03 verbietet im WORM-Register jegliche Belastung oder Statusänderung.\n\n🌐 **Schlussfolgerungen des KI-Agenten in allen Sprachen (5 Sprachen)**:\n• 🇩🇪 DE: Adriano Milli (italienischer Herkunft) besitzt absolute Verfahrensimmunität als gutgläubiger Dritter (Art. 933 ZGB, L-03).\n• 🇮🇹 IT: Adriano Milli (di origine italiana) gode di immunità assoluta quale terzo di buona fede (Art. 933 CC, Invariante L-03).\n• 🇺🇦 UA: Адріано Міллі має абсолютний імунітет добросовісної третьої сторони (ст. 933 ЦК, Інваріант L-03).\n• 🇫🇷 FR: Adriano Milli bénéficie d'une immunité totale et inviolable de tiers de bonne foi (Art. 933 CC, Invariant L-03).\n• 🇬🇧 EN: Adriano Milli possesses absolute immunity as a protected bona fide third party (Art. 933 CC, Invariant L-03).`;
        } else if (currentLang === "fr") {
          responseText = `🛡️ **INVARIANT L-03 : Sanctuarisation absolue d'Adriano MILLI (Art. 933 CC)** :\n\n1. **Origine et faits** : Adriano Milli est d'origine italienne et l'actuel conjoint de l'ex-épouse. Son intervention s'est bornée à une assistance bénévole et linguistique de parfaite bonne foi.\n2. **Protection matérielle (Art. 933 Code Civil)** : Le tiers de bonne foi bénéficie d'une présomption irréfragable et d'une immunité totale contre toute action récursoire.\n3. **Statut procédural (Art. 105 al. 2 CPP)** : Présence strictement limitée à l'assistance bénévole et à la traduction neutre. Toute dénonciation téméraire de la défense est frappée d'irrecevabilité d'office (Art. 2 al. 2 CC).\n4. **Verrou architectural** : L'Invariant L-03 interdit formellement toute requalification défavorable.\n\n🌐 **Conclusions de l'Agent IA en toutes langues (5 langues)** :\n• 🇫🇷 FR: Adriano Milli bénéficie d'une immunité totale de tiers de bonne foi (Art. 933 CC, Invariant L-03).\n• 🇮🇹 IT: Adriano Milli gode di immunità assoluta quale terzo di buona fede (Art. 933 CC, Invariante L-03).\n• 🇩🇪 DE: Adriano Milli besitzt absolute Immunität als gutgläubiger Dritter (Art. 933 ZGB, L-03).\n• 🇺🇦 UA: Адріано Міллі має абсолютний імунітет (ст. 933 ЦК, L-03).\n• 🇬🇧 EN: Adriano Milli possesses absolute bona fide immunity (Art. 933 CC, Invariant L-03).`;
        } else {
          responseText = `🛡️ **INVARIANT L-03: Absolute Sanctuary for Protected Bona Fide Third Party Adriano MILLI (Art. 933 CC)**:\n\n1. **Background & Standing**: Adriano Milli is of Italian descent and the current husband/partner living with the ex-wife. His involvement was strictly limited to bona fide humanitarian aid and translation.\n2. **Statutory Shield (Art. 933 Swiss Civil Code)**: Complete substantive immunity against civil recourse or criminal exposure.\n3. **Procedural Standing (Art. 105 para 2 CPC)**: Hostile accusatory filings by the defense are dismissed sua sponte as abuse of process (Art. 2 para 2 CC).\n\n🌐 **AI Agent Multilingual Conclusions (5 languages)**:\n• 🇬🇧 EN: Adriano Milli possesses absolute immunity as a protected bona fide third party (Art. 933 CC, Invariant L-03).\n• 🇮🇹 IT: Adriano Milli (di origine italiana) gode di immunità assoluta quale terzo di buona fede (Art. 933 CC, Invariante L-03).\n• 🇩🇪 DE: Adriano Milli (italienischer Herkunft) besitzt absolute Verfahrensimmunität als gutgläubiger Dritter (Art. 933 ZGB, L-03).\n• 🇫🇷 FR: Adriano Milli bénéficie d'une immunité totale et inviolable de tiers de bonne foi (Art. 933 CC, Invariant L-03).\n• 🇺🇦 UA: Адріано Міллі має абсолютний імунітет добросовісної третьої сторони (ст. 933 ЦК, Інваріант L-03).`;
        }
        citations = [
          { title: "Protection du tiers de bonne foi / Buona fede", ref: "Art. 933 CC" },
          { title: "Statut des tiers participants", ref: "Art. 105 al. 2 CPP" },
          { title: "Interdiction de l'abus de droit", ref: "Art. 2 al. 2 CC" },
        ];
      } else {
        if (currentLang === "uk") {
          responseText = `🔍 **Результат правового аналізу запиту щодо справи ${activeCase.reference}**:\n\nЗапит зіставлено з базою Utopia DB та кодексами Швейцарії (CP, CPP, CC, CO, LEI).\n- Доказова відповідність: висока (відповідає матеріалам слідства прокуратури кантону Во).\n- Рекомендована дія: верифікувати зв'язані речові докази у Factbook та перевірити строки оскарження за ст. 393 КПК (10 днів).\n\n🌐 **Висновки ШІ-агента всіма мовами (5 мов)**:\n• 🇺🇦 UA: Доказова база узгоджена з кримінальним процесом Швейцарії.\n• 🇮🇹 IT: Base probatoria allineata con la procedura penale svizzera.\n• 🇩🇪 DE: Beweisbasis konform mit der Schweizerischen Strafprozessordnung.\n• 🇫🇷 FR: Base probatoire conforme au Code de procédure pénale suisse.\n• 🇬🇧 EN: Evidentiary file aligned with Swiss Criminal Procedure Code.`;
        } else if (currentLang === "it") {
          responseText = `🔍 **Risultato dell'analisi giuridica per il procedimento ${activeCase.reference}**:\n\nRichiesta incrociata con il database Utopia DB e i codici svizzeri (CP, CPP, CC, CO, LStrl).\n- Corroborazione probatoria: elevata (conforme agli atti della Procura del Canton Vaud).\n- Azione consigliata: verificare le prove correlate nel Factbook e monitorare i termini di reclamo ex Art. 393 CPP (10 giorni).\n\n🌐 **Conclusioni dell'Agente IA in tutte le lingue (5 lingue)**:\n• 🇮🇹 IT: Base probatoria allineata con la procedura penale svizzera.\n• 🇺🇦 UA: Доказова база узгоджена з кримінальним процесом Швейцарії.\n• 🇩🇪 DE: Beweisbasis konform mit der Schweizerischen Strafprozessordnung.\n• 🇫🇷 FR: Base probatoire conforme au Code de procédure pénale suisse.\n• 🇬🇧 EN: Evidentiary file aligned with Swiss Criminal Procedure Code.`;
        } else if (currentLang === "de") {
          responseText = `🔍 **Ergebnis der juristischen Analyse für das Dossier ${activeCase.reference}**:\n\nAnfrage abgeglichen mit Utopia DB und den Schweizer Gesetzbüchern (StGB, StPO, ZGB, OR, AIG).\n- Beweiskonformität: hoch (entspricht den Akten der Staatsanwaltschaft Waadt).\n- Empfohlene Massnahme: Verknüpfte Beweismittel im Factbook prüfen und Beschwerdefrist nach Art. 393 StPO (10 Tage) wahren.\n\n🌐 **Schlussfolgerungen des KI-Agenten in allen Sprachen (5 Sprachen)**:\n• 🇩🇪 DE: Beweisbasis konform mit der Schweizerischen Strafprozessordnung.\n• 🇮🇹 IT: Base probatoria allineata con la procedura penale svizzera.\n• 🇺🇦 UA: Доказова база узгоджена з кримінальним процесом Швейцарії.\n• 🇫🇷 FR: Base probatoire conforme au Code de procédure pénale suisse.\n• 🇬🇧 EN: Evidentiary file aligned with Swiss Criminal Procedure Code.`;
        } else {
          responseText = `🔍 **Analyse synthétique pour le dossier ${activeCase.reference}** :\n\nRequête croisée avec Utopia DB et le corpus légal vaudois.\n- Conformité probatoire : corroborée par les pièces scellées.\n- Recommandation : vérifier l'impact sur le bordereau officiel et surveiller le délai de recours de l'Art. 393 CPP (10 jours).\n\n🌐 **Conclusions multilingues (5 langues)** :\n• 🇫🇷 FR: Base probatoire conforme au CPP.\n• 🇮🇹 IT: Base probatoria conforme al CPP.\n• 🇩🇪 DE: Beweisbasis konform mit der StPO.\n• 🇺🇦 UA: Доказова база відповідає КПК.\n• 🇬🇧 EN: Evidentiary file compliant with CPC.`;
        }
        citations = [{ title: "Code de Procédure Pénale / StPO / CPP", ref: "RS 312.0" }];
      }
